...
main_sheets <- c("ROPO CELKEM","OSS (RO)","PO","OOSS","STÁTNÍ SPRÁVA","ÚO","OSS SS",
               "SOBCPO")
...
subgroup_sheets<-c("ZAMCI_5011_platy","VOJACI_5012","ST_ZAMCI_5013","ST_ZÁSTUP_5014","ÚČ_S_5022","SOBCPO  JEDNOTLIVÝ","OSS SS - jednotl")
...
summary_names <- c("Rozpocet_a_rok","Skupina","Prostředky na platy a OPPP", "OPPP", "Prostředky na platy",
                   "Počet zaměstnanců", "Průměrný plat", "Pořadí průměrného platu","Schv ke schv", "Skut k rozp", "Skut ke skut")
