...
B3<-plot_ly(bar_dt,
  ...
  layout(
    hovermode = "closest",
    title = list(text = "Graf B3. Pr\u016Fm\u011Brn\u00E9 platy st\u00E1tn\u00EDch zam\u011Bstnanc\u016F (v tis\u00EDc\u00EDch)", y = 0.98),
    xaxis = list(title = "", categoryorder = "array", categoryarray = arrange(bar_dt, prostredky_na_platy_agg)$kap_name),
    yaxis = list(title = ""),
    showlegend = F
  ) %>%
  config(modeBarButtonsToRemove = c("zoomIn2d", "zoomOut2d", "pan2d", "lasso2d", "select2d", "autoScale2d"), displaylogo = FALSE)
...
```{r mean_costs_main, echo=FALSE, out.width="100%",warning = FALSE,message = FALSE}
