...
graf_A1 <- tree_data %>%
  ...
  layout(title = list(font=list(color = cap_col),text = "<b>Graf A1. Výdaje na platy státních zaměstnanců dle regulace zaměstnanosti, rok 2020</b>", 
                      y = 0.98)) %>%
  layout( annotations = list(text = "Poznámka: Pro bližší detail lze kategorie rozkliknout", 
...
graf_1 <- tree_data %>%
  ...
  layout(title = list(font=list(color = cap_col),
                      ...
                      y = 0.98)) %>%
  layout(annotations = list(text = "Poznámka: Pro bližší detail lze kategorie rozkliknout", x = 1, 
...
graf_2 <- bar_dt %>% group_by(kategorie_2014_cz)%>%
  ...
  layout(
    ...
    annotations = list(text = str_wrap("Poznámka: Ministerstvo školství, mládeže a tělovýchovy zkresluje graf vzhledem k zahrnutí  učitelů v kategorii “Příspěvkové organizace”. Lze odflitrovat v legendě nebo v grafu.",40),
                       align='left',
                       xref='paper',
                       yref='paper',
                       x=1.33,
    ...
    xaxis = list(tickfont=list(size=10),title = "Kapitoly",tickmode = "array",categoryorder = "array", 
...
graf_4 <- dt %>%
  ...
  layout(
    ...
    title = list(font=list(color = cap_col),text = "<b>Graf 4. Počet státních úředníků (2003–2020, tisíce)</b>", 
                 y = 0.98),
    annotations = list(text = str_wrap("Poznámka: Pro srovnatelnost v čase graf nezahrnuje zaměstnance ministerstev vnitra a zahraničních věcí, viz <b> Přílohu 1: Data a metodologie. </b> Graf 4 s kapitolami ministerstev vnitra a zahraničních věcí je v příloze.",40),
                       align='left',
                       xref='paper',
                       yref='paper',
                       x=1.33,
...
graf_A4 <- vyvoj_bar %>%
  ...
  layout(
    ...
    title = list(font=list(color = cap_col),
                 ...
                 y = 0.98),
    annotations = list(text = str_wrap("Poznámka: Pro srovnatelnost v čase graf nezahrnuje zaměstnance ministerstev vnitra a zahraničních věcí, viz <b> Přílohu 1: Data a metodologie. </b>",40),
                       align='left',
                       xref='paper',
                       yref='paper',
                       x=1.33,
...
graf_A6 <- aux2 %>%
  ...
  layout(margin = mrg2,
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = cap_col),text = str_wrap("<b>Graf A6. Změna reálných výdajů na platy státních úředníků k základně roku 2003</b>",70), y = 0.96),
    annotations = list(text = str_wrap("Poznámka: Pro srovnatelnost v čase graf nezahrnuje zaměstnance ministerstev vnitra a zahraničních věcí, viz <b> Přílohu 1: Data a metodologie.</b> ",40),
                       align='left',
                       xref='paper',
                       yref='paper',
...
graf_A7 <- dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = cap_col),
                 text = str_wrap("<b>Graf A7. Změna reálných průměrných platů státních úředníků k základně roku 2003</b>",70), 
                 y = 0.96),
    annotations = list(text = str_wrap("Poznámka: Pro srovnatelnost v čase graf nezahrnuje zaměstnance ministerstev vnitra a zahraničních věcí, viz <b>Přílohu 1: Data a metodologie. </b>",40),
                       align='left',
                       xref='paper',
...
graf_A14 <- dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = cap_col),text = "<b>Graf A14. Počet státních úředníků 2003–2020 (tisíce)</b>", y = 0.98),
    annotations = list(text = str_wrap("Poznámka: Zahrnuty kapitoly ministerstva vnitra a zahraničních věcí",40),
                       align='left',
                       xref='paper',
                       yref='paper',
                       x=1.33,
...
graf_A15 <- plot_ly(pubsec, type = "scatter", mode = "lines+markers", line = list(width = 4),
    marker = list(size=0.5,symbol = "circle",line = list(width = 5,color="white")),
    hovertemplate = ~ paste(
          "<extra></extra>",
          "Rok: ", rok, "<br>",
    ...
    layout(plot_bgcolor='whitesmoke',
           ...
           legend = list(x = 100, y = 0.5), showlegend = F,
           title = list(font=list(color = cap_col),
                        text = "<b>Graf A15. Počet zaměstnanců veřejného sektoru (tis. přepočtených osob)</b>",
                        y = 0.98), margin = mrg2) %>%
  config(modeBarButtonsToRemove = btnrm, displaylogo = FALSE)
```
