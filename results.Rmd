...
plot_ly(bar_dt,
  x = ~kap_name, y = ~ pocet_zamestnancu / 1000,name=~kategorie_2014_cz,type="bar",marker = list(color = cols),
...
```{r mean_costs_SS,include = FALSE, echo=FALSE, out.width="100%",warning = FALSE,message = FALSE}
