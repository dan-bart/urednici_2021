...
graf_2<-bar_dt %>% group_by(kategorie_2014_cz)%>%
  ...
  layout(
    ...
    annotations = list(text = str_wrap("Poznámka: MŠMT zkresluje graf vzhledem k zahrnutí  učitelů v kategorii “Příspěvkové organizace”. Lze odflitrovat v legendě nebo v grafu.",40),
                       ...
                       borderwidth=1,
                       showarrow = FALSE),
    title = list(font=list(color = "mediumblue"),text = "<b>Graf 2. Po\u010Det st\u00E1tn\u00EDch zam\u011Bstnanc\u016F dle rozpo\u010Dtov\u00FDch kapitol (v tis\u00EDc\u00EDch)</b>", y = 0.98),
...
graf_A2 <- plot_ly(bar_dt,
  ...
  layout(
    plot_bgcolor='whitesmoke',
    hovermode = "closest",
    title = list(font=list(color = "mediumblue"),text = "<b>Graf A2. Výdaje na platy státních zaměstnanců (v miliard\u00E1ch)</b>", y = 0.98),
...
graf_3<-bar_dt %>%
  ...
  layout(
    ...
    hovermode = "closest",
    title = list(font=list(color = "mediumblue"),text = "<b>Graf 3. Pr\u016Fm\u011Brn\u00E9 platy st\u00E1tn\u00EDch zam\u011Bstnanc\u016F (v tis\u00EDc\u00EDch)</b>", y = 0.98),
...
graf_B3 <- aux %>%
  ...
  group_map(~ plot_ly(
    ...
    layout(
      ...
      title = list(font=list(color = "mediumblue"),text = "<b>Graf B3. Pr\u016Fm\u011Brn\u00E9 platy st\u00E1tn\u00EDch zam\u011Bstnanc\u016F (v tis\u00EDc\u00EDch)</b>", x = 50, y = 0.98), legend = list(x = 50, y = 0.5), 
      showlegend = F
    ), keep = TRUE) %>%
...
graf_A3 <- bar_dt %>%
  ...
  group_map(~ plot_ly(
    ...
    layout(margin = list(t = 50),
      ...
      title = list(font=list(color = "mediumblue"),text = str_wrap("<b>Graf A3. Pr\u016Fm\u011Brn\u00E9 platy st\u00E1tn\u00EDch zam\u011Bstnanc\u016F (ve vztahu ke mzd\u011B v n\u00E1rodn\u00EDm hospod\u00E1\u0159stv\u00ED)</b>",70), 
...
graf_4<-dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = "<b>Graf 4. Počet státních úředníků 2003-2020 (v tisících)</b>", 
                 y = 0.98),
...
graf_A4 <- vyvoj_bar %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = "<b>Graf A4. Výdaje na platy státních úředníků 2003-2020 (v miliardách Kč)</b>", y = 0.98),
...
graf_A5 <- vyvoj_bar %>%
  ...
  layout(margin = list(t = 50),
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = str_wrap("<b>Graf A5. Reálné výdaje na platy státních úředníků 2003-2020 (v miliardách Kč, ceny roku 2020)</b>",70), y = 0.95),
    annotations = list(text = str_wrap("Pro přehlednost vynechány kapitoly MZV a MV, které by vzhledem ke strukturálním změnám způsobily kumulativní nárůst o zhruba 60% na Ministerstvech mezi roky 2011-2012.<br>V roce 2011 došlo k změně klasifikace státních zaměstnanců, která způsobila část změny v počtu státních úředníků z roku 2010 na rok 2011. Detaily viz text.",40),
                       align='left',
                       xref='paper',
                       yref='paper',
...
graf_A6 <- aux2 %>%
  plot_ly(
    ...
    marker = list(color = "white",symbol = "circle",line = list(width = 1)),
    text = ~ paste(
  ...
  layout(margin = list(t = 50),
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = str_wrap("<b>Graf A6. Kumulovaná změna reálných výdajů na platy státních úředníků 2003-2020 (v %)</b>",70), y = 0.95),
    annotations = list(text = str_wrap("Pro přehlednost, vynechány kapitoly MZV a MV, které by vzhledem ke strukturálním změnám způsobily kumulativní nárůst o zhruba 60% na Ministerstvech mezi roky 2011-2012.<br>V roce 2011 došlo k změně klasifikace státních zaměstnanců, která způsobila část změny v počtu státních úředníků z roku 2010 na rok 2011. Detaily viz text.",40),
                       align='left',
                       xref='paper',
                       yref='paper',
...
graf_5 <- dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = 
      list(font=list(color = "mediumblue"),text = "<b>Graf 5. Reálné průměrné hrubé měsíční platy (v tisících; ceny roku 2020)</b>", y =0.98),
    xaxis = list(title = ""),
...
graf_A7 <- dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = "<b>Graf A7. Kumulovaná změna reálných průměrných platů státních úředníků (v %)</b>", y = 0.98),
...
graf_A8 <- dt %>%
  ...
  layout(
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = "mediumblue"),text = "<b>Graf A8. Celkové reálné změny platů a počtu zaměstnanců v období 2004-2020</b>", y = 0.98),
    annotations = list(text = str_wrap("Pro přehlednost vynechány kapitoly MZV a MV, které by vzhledem ke strukturálním změnám způsobily kumulativní nárůst o zhruba 60% na Ministerstvech mezi roky 2011-2012.",40),
                       align='left',
                       xref='paper',
                       yref='paper',
...
graf_A13 <- dt %>%
  ...
  layout(title = list(font=list(color = "mediumblue"),text = "<b>Graf A13. Procentuální nárůst průměrných platů vs průměrný plat v roce 2003</b>",
