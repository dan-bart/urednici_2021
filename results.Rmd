...
graf_A4 <- vyvoj_bar %>%
  plot_ly(
    x = ~rok, y = ~ prostredky_na_platy_nom / 1e9, color = ~kategorie_2014_cz, colors = color_map,
    hovertemplate = ~ paste(
      "<extra></extra>", "Rok:", rok, "<br>", "Kategorie:", kategorie_2014_cz, "<br>",
...
```{r graphs, eval = FALSE, include = FALSE}
graf_list<-list(
graf_1,
graf_2,
graf_3,
