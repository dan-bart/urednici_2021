...
graf_A6 <- aux2 %>%
  ...
  layout(margin = mrg2,
    plot_bgcolor='whitesmoke',
    title = list(font=list(color = cap_col),text = str_wrap("<b>Graf A6. Změna reálných výdajů na platy státních úředníků od roku 2020</b>",70), y = 0.96),
    annotations = list(text = str_wrap("Pro srovnatelnost v čase graf nezahrnuje zaměstnance ministerstev vnitra a zahraničních věcí, viz <b> Přílohu 1: Data a metodologie. </b>",40),
                       align='left',
                       xref='paper',
                       yref='paper',
