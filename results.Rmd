...
bar_dt %>%
  ...
  group_map(~ plot_ly(
    ...
    layout(
      ...
      title = list(text = "Pr\u016Fm\u011Brn\u00E9 m\u011Bs\u00ED\u010Dn\u00ED platy ve st\u00E1tn\u00ED spr\u00E1v\u011B ve vztahu k pr\u016Fm\u011Brn\u00E9 mzd\u011B v n\u00E1rodn\u00EDm hospod\u00E1\u0159stv\u00ED", x = 50, y = 0.98), legend = list(x = 50, y = 0.5), showlegend = F
    ), keep = TRUE) %>%
