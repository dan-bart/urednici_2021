...
Pokud není u jednotlivých grafů uvedeno jinak, vycházíme z dat Státního závěrečného účtu, resp. Monitoru státní pokladny (oba sledují stejné věci.)

Pro vybrané části využítáme Informační systém o průměrném výdělku, popř. výstupy ČSÚ.
